...
const LocationCard: React.FC<LocationCardProps> = ({
  ...
  return <Card className="p-4 hover:shadow-md transition-shadow cursor-pointer relative flex flex-col" onClick={() => handleViewDetails(id)}>
      <div className="space-y-2">
        ...
        <div className="flex items-center text-muted-foreground text-sm">
          ...
          {distance && <Badge variant="outline" className="ml-2 bg-gray-100 font-normal">
              {distance}
            </Badge>}
        </div>
      </div>
